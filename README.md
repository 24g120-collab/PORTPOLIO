<html>
    <header>
        <div>
          <div style="font-weight:700"> I'm SHALINI</div><br>
...
<section class="recipe-card">
  <div class="card-body">
    <img src="https://example.com/tomato-pasta.jpg" alt="Creamy Tomato Pasta" width="100%">
    <h3>One-Pot Creamy Tomato Pasta</h3>
    <p>A rich and comforting pasta dish made in one pot with tomatoes, herbs, and cheese.</p>
...
<section class="recipe-card">
  <div class="card-body">
    <img src="https://example.com/cauliflower-salad.jpg" alt="Roasted Cauliflower Salad" width="100%">
    <h3>Roasted Cauliflower Salad</h3>
    <p>Crunchy roasted cauliflower tossed with chickpeas, herbs, and a lemon tahini dressing.</p>
    <button>View Recipe</button>
  </div>
</section>
...
<section class="recipe-card">
  <div class="card-body">
    <img src="https://example.com/yogurt-parfait.jpg" alt="Cardamom Honey Yogurt Parfait" width="100%">
    <h3>Cardamom Honey Yogurt Parfait</h3>
    <p>Layered Greek yogurt with honey, granola, and a hint of cardamom for a refreshing treat.</p>
    <button>View Recipe</button>
  </div>
</section>
</header><section class="hero">
...
<section id="contact">
  ...
  <div class="contact">
<p>Phone number:9840202357</p>
<p>Email id:shalini10@gmail.com</p>
  </select>
